...
#
#       placeformat     - Format of Place to display added by Hans Ulrich Frink <hansulrich.frink@gmail.com>
#       put in following path: gramps\plugins\textreports
...
#
#------------------------------------------------------------------------
class MYDetDescendantReport(Report):
    ...
    def __init__(self, database, options, user):
        ...
        self.pl_format     = get_value('placeformat')
        ...
        self.__narrator = Narrator(self.db, self.pl_format, self.verbose,
...
#------------------------------------------------------------------------
#
# MYDetDescendantOptions
#
#------------------------------------------------------------------------
class MYDetDescendantOptions(MenuReportOptions):
    ...
    def add_menu_options(self, menu):
        ...
        add_option("placeformat", placeformat)
