...
#        self.showpersons = menu.get_option_by_name('showpersons').get_value()
        self.showMF = menu.get_option_by_name('showMF').get_value()
...
#        
        showMF = BooleanOption(_("Show mother and father"), True)
        showMF.set_help(_("Whether to show additional lines for mother or father"))
        menu.add_option(category_name, "showMF", showMF)
#
#
