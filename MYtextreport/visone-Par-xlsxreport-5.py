...
#                                    "m")
    ...
    #                                    (d)) 
                ...
                lon_txt =""
                self.doc.start_paragraph("SRC-SourceDetails")
                lat_txt, lon_txt = self.find_place_lat_lon(self.__db.get_event_from_handle(b))
                self.doc.write_text(_("%s") %
                             lat_txt)
                self.doc.end_paragraph()
                self.doc.end_cell()
...
#4.1        evkeys.sort
        ...
        column_titles = [_("Prim_ID"), _("Gramps_ID"),  _("Role"), _("Relation"), _("Kinship Path prim ->pers"), _("LNr"), _("Ev ID"),_("Event"), _("Date"), _("Year"), _("Age Primary"), _("Age Person"), _("gender Primary"), _("gender Person"),_("Primary") , _("Person"), _("Person birth"), _("Person Clan"),_("Primary Clan"),_("Event Place"),_("FamID"),_("AnzKind"),_("Latitude"),_("Longitude")] 
        i = 0
        self.doc.start_row()
